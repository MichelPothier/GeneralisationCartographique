...
'**
'Nom de la composante : cmdCorrigerLongueurLigne.vb
'
'''<summary>
''' Commande qui permet de corriger la longueur des lignes des éléments sélectionnés selon une longueur minimale
...
'''</remarks>
''' 
Public Class cmdCorrigerLongueurLigne
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la longueur des lignes ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la longueur des lignes ... " & vbCrLf & vbCrLf
                ...
                'Corriger la longueur minimale des lignes des éléments sélectionnés
                modGeneralisation.CorrigerLongueurLignes(m_Precision, m_LongueurLigne, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
