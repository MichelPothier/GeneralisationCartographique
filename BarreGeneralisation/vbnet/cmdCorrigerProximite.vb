...
'**
'Nom de la composante : cmdCorrigerProximite.vb
'
'''<summary>
''' Commande qui permet de corriger la proximité des éléments sélectionnés selon une tolérance à l'aide des outils de topologie.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdCorrigerProximite
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la proximité ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la proximité des éléments ... " & vbCrLf & vbCrLf
                ...
                'Corriger la proximité des éléments sélectionnés
                modGeneralisation.CorrigerProximite(m_Precision, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
