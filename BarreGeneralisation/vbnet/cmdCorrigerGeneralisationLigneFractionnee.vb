...
'**
'Nom de la composante : cmdCorrigerGeneralisationLigneFractionnee.vb
'
'''<summary>
''' Commande qui permet de corriger la généralisation des éléments de type ligne sélectionnés fractionnées et selon une largeur, une longueur minimale
...
'''</remarks>
''' 
Public Class cmdCorrigerGeneralisationLigneFractionnee
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                'Corriger la généralisation des lignes fractionnée pour les éléments sélectionnés
                modGeneralisation.CorrigerGeneralisationLignesFractionnees(m_Precision, m_DistanceLaterale, m_LargeurExterieure, m_LongueurExterieure, m_LongueurLigne,
