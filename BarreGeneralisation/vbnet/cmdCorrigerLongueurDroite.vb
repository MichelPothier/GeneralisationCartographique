...
'**
'Nom de la composante : cmdCorrigerLongueurDroite.vb
'
'''<summary>
''' Commande qui permet de corriger la longueur des droites des éléments sélectionnés selon une longueur 
''' à l'aide des outils de topologie tout en conservant la connexion entre les éléments.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdCorrigerLongueurDroite
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la longueur des droites ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la longueur des droites ... " & vbCrLf & vbCrLf
                ...
                m_MenuGeneralisation.rtbMessages.Text = m_MenuGeneralisation.rtbMessages.Text & "Longueur minimale d'une droite : " & m_LongueurDroite.ToString & vbCrLf
                ...
                'Corriger la longueur minimale des droites des éléments sélectionnés
                modGeneralisation.CorrigerLongueurDroites(m_Precision, m_LongueurDroite, True, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
