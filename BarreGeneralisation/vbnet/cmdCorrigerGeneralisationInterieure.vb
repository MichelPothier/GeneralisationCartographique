...
'**
'Nom de la composante : cmdCorrigerGeneralisationInterieure.vb
'
'''<summary>
''' Commande qui permet de corriger la généralisation intérieure des éléments sélectionnés selon une largeur, une longueur et une superficie minimale
...
'''</remarks>
''' 
Public Class cmdCorrigerGeneralisationInterieure
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la généralisation intérieure ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la généralisation intérieure ... " & vbCrLf & vbCrLf
                ...
                m_MenuGeneralisation.rtbMessages.Text = m_MenuGeneralisation.rtbMessages.Text & "Largeur de généralisation minimale: " & m_LargeurInterieure.ToString & vbCrLf
                ...
                m_MenuGeneralisation.rtbMessages.Text = m_MenuGeneralisation.rtbMessages.Text & "Superficie minimale d'un anneau : " & m_SuperficieExterieure.ToString & vbCrLf
                ...
                'Corriger la généralisation intérieure des éléments sélectionnés
                modGeneralisation.CorrigerGeneralisationInterieure(m_Precision, m_DistanceLaterale, m_LargeurInterieure, m_LongueurInterieure, m_SuperficieExterieure,
                                                            m_ClasseGeneraliser, m_ClasseSquelette, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
