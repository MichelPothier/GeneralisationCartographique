...
'**
'Nom de la composante : cmdCorrigerDupplicationLigne.vb
'
'''<summary>
''' Commande qui permet de corriger la dupplication des lignes pour les éléments sélectionnés de type ligne
...
'''</remarks>
''' 
Public Class cmdCorrigerDupplicationLigne
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la duplication des lignes ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la duplication des lignes ... " & vbCrLf & vbCrLf
                ...
                'Corriger la dupplication des éléments de type ligne sélectionnés
                modGeneralisation.CorrigerDupplicationLignes(m_Precision, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
