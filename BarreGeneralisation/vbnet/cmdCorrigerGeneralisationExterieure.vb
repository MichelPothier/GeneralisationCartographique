...
'**
'Nom de la composante : cmdCorrigerGeneralisationExterieure.vb
'
'''<summary>
''' Commande qui permet de corriger la généralisation extérieure des éléments sélectionnés selon une largeur, une longueur et une superficie minimale
...
'''</remarks>
''' 
Public Class cmdCorrigerGeneralisationExterieure
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la généralisation extérieure ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction la généralisation extérieure ... " & vbCrLf & vbCrLf
                ...
                'Corriger la généralisation extérieure des éléments sélectionnés
                modGeneralisation.CorrigerGeneralisationExterieure(m_Precision, m_DistanceLaterale, m_LargeurExterieure, m_LongueurExterieure, m_SuperficieExterieure,
                                                            True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
