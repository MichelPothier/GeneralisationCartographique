...
'**
'Nom de la composante : cmdCorrigerSegmentationManquante.vb
'
'''<summary>
''' Commande qui permet de corriger la segmentation manquante des éléments sélectionnés selon les éléments en relation à l'aide des outils de topologie.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdCorrigerSegmentationManquante
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la segmentation manquante en cours ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la segmentation manquante des éléments ... " & vbCrLf & vbCrLf
                ...
                'Corriger la segmentation manquante des éléments sélectionnés
                modGeneralisation.CorrigerSegmentationManquante(m_Precision, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
