...
'**
'Nom de la composante : cmdCorrigerSegmentationEnTrop.vb
'
'''<summary>
''' Commande qui permet de corriger la segmentation en trop des éléments sélectionnés selon les éléments en relation à l'aide des outils de topologie.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdCorrigerSegmentationEnTrop
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la segmentation en trop en cours ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la segmentation en trop des éléments ... " & vbCrLf & vbCrLf
                ...
                m_MenuGeneralisation.rtbMessages.Text = m_MenuGeneralisation.rtbMessages.Text & "Attributs d'adjacence : " & m_AttributsAdjacence & vbCrLf
                ...
                'Corriger la segmentation en trop des éléments sélectionnés
                modGeneralisation.CorrigerSegmentationEnTrop(m_Precision, m_AttributsAdjacence, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
