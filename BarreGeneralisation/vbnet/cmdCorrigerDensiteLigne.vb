...
'**
'Nom de la composante : cmdCorrigerDensiteLigne.vb
'
'''<summary>
''' Commande qui permet de corriger la densité des lignes fermées pour les éléments sélectionnés selon une longueur minimum.
'''</summary>
'''
'''<remarks>
...
'''</remarks>
''' 
Public Class cmdCorrigerDensiteLigne
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la densité des lignes fermées ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la densité des lignes fermées ... " & vbCrLf & vbCrLf
                ...
                m_MenuGeneralisation.rtbMessages.Text = m_MenuGeneralisation.rtbMessages.Text & "Longueur minimale d'une ligne : " & m_LongueurLigne.ToString & vbCrLf
                ...
                'Corriger la densité des lignes fermées pour les éléments sélectionnés
                modGeneralisation.CorrigerDensiteLignes(m_Precision, m_LongueurLigne, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
