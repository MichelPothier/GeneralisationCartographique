...
'**
'Nom de la composante : cmdCorrigerFiltrage.vb
'
'''<summary>
''' Commande qui permet de corriger le filtrage des éléments sélectionnés selon une distance latérale (Douglas-Peuker) 
...
'''</remarks>
''' 
Public Class cmdCorrigerFiltrage
    ...
    Protected Overrides Sub OnClick()
        ...
        Try
            ...
            If TypeOf (m_MxDocument.FocusMap.SpatialReference) Is IProjectedCoordinateSystem Then
                ...
                m_Application.StatusBar.ShowProgressBar("Correction de la distance latérale des sommets ...", 0, m_MxDocument.FocusMap.SelectionCount, 1, True)
                ...
                m_MenuGeneralisation.rtbMessages.Text = "Correction de la distance latérale des sommets ... " & vbCrLf & vbCrLf
                ...
                'Corriger le filtrage latérale des éléments sélectionnés
                modGeneralisation.CorrigerFiltrage(m_Precision, m_DistanceLaterale, True, m_CreerFichierErreurs, iNbErreurs, pTrackCancel)
